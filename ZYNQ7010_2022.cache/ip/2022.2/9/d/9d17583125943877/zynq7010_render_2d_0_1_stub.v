...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(ap_clk, ap_rst_n, ap_start, ap_done, ap_idle, 
  ap_ready, ap_return, m_axi_vram_AWID, m_axi_vram_AWADDR, m_axi_vram_AWLEN, 
  m_axi_vram_AWSIZE, m_axi_vram_AWBURST, m_axi_vram_AWLOCK, m_axi_vram_AWREGION, 
  m_axi_vram_AWCACHE, m_axi_vram_AWPROT, m_axi_vram_AWQOS, m_axi_vram_AWVALID, 
  m_axi_vram_AWREADY, m_axi_vram_WID, m_axi_vram_WDATA, m_axi_vram_WSTRB, m_axi_vram_WLAST, 
  m_axi_vram_WVALID, m_axi_vram_WREADY, m_axi_vram_BID, m_axi_vram_BRESP, 
  m_axi_vram_BVALID, m_axi_vram_BREADY, m_axi_vram_ARID, m_axi_vram_ARADDR, 
  m_axi_vram_ARLEN, m_axi_vram_ARSIZE, m_axi_vram_ARBURST, m_axi_vram_ARLOCK, 
  m_axi_vram_ARREGION, m_axi_vram_ARCACHE, m_axi_vram_ARPROT, m_axi_vram_ARQOS, 
  m_axi_vram_ARVALID, m_axi_vram_ARREADY, m_axi_vram_RID, m_axi_vram_RDATA, 
  m_axi_vram_RRESP, m_axi_vram_RLAST, m_axi_vram_RVALID, m_axi_vram_RREADY)
/* synthesis syn_black_box black_box_pad_pin="ap_clk,ap_rst_n,ap_start,ap_done,ap_idle,ap_ready,ap_return[0:0],m_axi_vram_AWID[0:0],m_axi_vram_AWADDR[31:0],m_axi_vram_AWLEN[7:0],m_axi_vram_AWSIZE[2:0],m_axi_vram_AWBURST[1:0],m_axi_vram_AWLOCK[1:0],m_axi_vram_AWREGION[3:0],m_axi_vram_AWCACHE[3:0],m_axi_vram_AWPROT[2:0],m_axi_vram_AWQOS[3:0],m_axi_vram_AWVALID,m_axi_vram_AWREADY,m_axi_vram_WID[0:0],m_axi_vram_WDATA[63:0],m_axi_vram_WSTRB[7:0],m_axi_vram_WLAST,m_axi_vram_WVALID,m_axi_vram_WREADY,m_axi_vram_BID[0:0],m_axi_vram_BRESP[1:0],m_axi_vram_BVALID,m_axi_vram_BREADY,m_axi_vram_ARID[0:0],m_axi_vram_ARADDR[31:0],m_axi_vram_ARLEN[7:0],m_axi_vram_ARSIZE[2:0],m_axi_vram_ARBURST[1:0],m_axi_vram_ARLOCK[1:0],m_axi_vram_ARREGION[3:0],m_axi_vram_ARCACHE[3:0],m_axi_vram_ARPROT[2:0],m_axi_vram_ARQOS[3:0],m_axi_vram_ARVALID,m_axi_vram_ARREADY,m_axi_vram_RID[0:0],m_axi_vram_RDATA[63:0],m_axi_vram_RRESP[1:0],m_axi_vram_RLAST,m_axi_vram_RVALID,m_axi_vram_RREADY" */;
  input ap_clk;
  input ap_rst_n;
  input ap_start;
  output ap_done;
