...
HD_PWD='/home/ztn/Embedded/ZYNQ7010_2022/ZYNQ7010_2022.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ece385final_z7_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ece385final_z7_top.tcl -notrace
