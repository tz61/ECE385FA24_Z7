...
HD_PWD='/home/ztn/Embedded/ZYNQ7010_2022/ZYNQ7010_2022.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ece385final_z7_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ece385final_z7_top.tcl
